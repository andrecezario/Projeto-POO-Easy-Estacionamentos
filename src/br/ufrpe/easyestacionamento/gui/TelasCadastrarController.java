...
public class TelasCadastrarController {
	...
	@FXML
	public void cadastrarClientes(ActionEvent event) throws IOException, ClienteJaExisteException, FuncionarioJaExisteException, LoginJaExisteException, VeiculoJaExisteException {
		try {
	...
	public void cadastrarFuncionarios(ActionEvent event)
			throws IOException, FuncionarioJaExisteException, LoginJaExisteException, ClienteJaExisteException, VeiculoJaExisteException {
		try {
	...
	public void cadastrarVeiculos(ActionEvent event)
			throws IOException, VeiculoJaExisteException, CpfNaoExisteException, FuncionarioJaExisteException, LoginJaExisteException, ClienteJaExisteException {
		try {
