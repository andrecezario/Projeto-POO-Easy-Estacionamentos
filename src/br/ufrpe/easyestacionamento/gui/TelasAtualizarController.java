...
public class TelasAtualizarController {
	...
	@FXML
	public void atualizarCliente(ActionEvent event) throws IOException, CpfNaoExisteException, LoginJaExisteException, PlacaNaoExisteException {
		try {
			...
			if (!(nome.equals("") || cpfCliente.getText().toString().equals("") || telefone.equals(""))) {
				...
				alert.setTitle("Atualiza��o de clientes");
			...
			alert.setContentText("N�o existe um cliente cadastrado com esse CPF para que possa atualizar!");
			alert.showAndWait();
	...
	public void atualizarFuncionario(ActionEvent event)
			throws IOException, CpfNaoExisteException, LoginJaExisteException, PlacaNaoExisteException {
		try {
			...
			if (!(nome.equals("") || logiN.equals("") || senhA.equals("")
				...
				Alert alert = new Alert(AlertType.INFORMATION, "Funcion�rio atualizado com sucesso!");
				alert.setTitle("Atualiza��o de funcion�rios");
				alert.setHeaderText("Funcion�rio atualizado");
				alert.showAndWait();
			} else {
				Alert alert = new Alert(AlertType.ERROR, "Preencha todos os campos!");
				alert.show();
			...
			alert.setTitle("Falha ao atualizar");
			alert.setHeaderText("Tente novamente");
			alert.setContentText("N�o existe um funcion�rio cadastrado com esse CPF para que possa atualizar!");
			alert.showAndWait();
	...
	@FXML
	public void atualizarVeiculo(ActionEvent event) throws IOException, PlacaNaoExisteException, CpfNaoExisteException, NumberFormatException, LoginJaExisteException {
		try {
			...
			if (!(nome.equals("") || cpfProprietarioVeiculo.getText().toString().equals("") || placA.equals("")
				...
				if (proprietarioVeiculo != null) {
					...
					Alert alert = new Alert(AlertType.INFORMATION, "Ve�culo atualizado com sucesso!");
					alert.setTitle("Atualiza��o de ve�culos");
					alert.setHeaderText("Ve�culo atualizado");
					alert.showAndWait();
				} else {
			...
			alert.setTitle("Falha ao atualizar");
			alert.setHeaderText("Tente novamente");
			alert.setContentText("N�o existe um ve�culo cadastrado com essa Placa para que possa atualizar!");
			alert.showAndWait();
